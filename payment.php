...
<html lang="">
	<head>
		...
		<title>(SEPM)Metro Ticket Booking</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="index.php"><span class="glyphicon glyphicon-backward"></span> Back Home</a></li>
    </ul>
  </div>
</nav>
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			...
			 			<p>Departure Date: <?= $_SESSION['departure_date']; ?> @5:00PM</p>
			 		</strong>
			 ...
			 <div class="panel panel-success">
				...
				PASSENGERS</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						   ...
						   <center>
							   <a href="index.php" class="btn btn-success">Login and Pay
