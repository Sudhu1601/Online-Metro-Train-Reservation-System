...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="transaction.php">Ticket Details
...
<div class="container-fluid">
	...
	<div class="col-md-10">
		<div id="trans-table"></div>
                <button type="button" onclick="acceptPayment();" class="btn btn-primary accept-pay">Print Ticket
	...
	$('.tenPercent').click(function(event) {
		...
		$.ajax({
				...
				success: function (data) {
					// console.log(data);
					if(data.valid == false){
						$('#modal-message').find('.modal-body').text('You are Already Refunded!');
						
					}else if(data.valid == true){
						showAllTransaction();
						$('#modal-message').find('.modal-body').text('Refund Successfull!');
					}
