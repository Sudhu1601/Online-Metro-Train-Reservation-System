...
<body background="https://cdn.dribbble.com/users/288987/screenshots/1898478/train-ride.gif" alt="this slowpoke moves"   />

<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<a class="navbar-brand" href="#">Online Ticketing</a>
		<ul class="nav navbar-nav">
			<li class="active"><a href="reservation.php">Booking Details
			<span class="glyphicon glyphicon-list" aria-hidden="true"></span>
			</a></li>
			<li class=""><a href="transaction.php">/
...
<div class="container-fluid">
	...
	<div class="col-md-10">
        ...
        <button type="button" onclick="acceptPayment();" class="btn btn-primary accept-pay">Print / Download Ticket
			...
			tot += Number(discounted);
				$.ajax({
	    			...
	    			success: function (data) {
	    				...
	    				showAllBook();
	    				$('#modal-message').find('.modal-body').text('Payment Successful! Print or download your ticket below')
